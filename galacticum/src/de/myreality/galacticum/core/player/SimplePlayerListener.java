...
public class SimplePlayerListener implements PlayerListener {
	...
	/* (non-Javadoc)
	 * @see de.myreality.galacticum.core.player.PlayerListener#onCreate(de.myreality.galacticum.core.player.Player)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.myreality.galacticum.core.player.PlayerListener#onDestroy(de.myreality.galacticum.core.player.Player)
	 */
	@Override
